...
from crud import crud_ventas, crud_inventario, crud_garantias
    ...
    while True:
        ...
        if op == "1":
            ...
            crud_ventas.registrar_venta(
                id_v, id_det, id_t, id_e, id_j, cant, precio, crud_inventario, id_c
            )
        elif op == "2":
...
def menu_inventario():
    while True:
        ...
        print("1. Sumar Stock a un Juguete existente")
        ...
        if op == "1":
            ...
            crud_inventario.gestionar_stock(id_j, cant)
        elif op == "2":
            crud_inventario.consultar_inventario_completo()
        elif op == "3":
            break
        else:
            print("\nOpción inválida. Intente de nuevo.")
